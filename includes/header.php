    ...
    <nav class="bento-top-nav">
        <div class="bento-top-nav-content">
            ...
            <div class="bento-nav-menu">
                ...
                ?>
                <a href="<?php echo $dashboard_link; ?>" class="bento-nav-link">
                    <i class="fas fa-home"></i> Inicio
                </a>
                <?php if (!empty($overdue_link)): ?>
                    <a href="<?php echo $overdue_link; ?>" class="bento-nav-link">
                        <i class="fas fa-wallet"></i> Finanzas
                        <?php if (!empty($overdue_count) && $overdue_count > 0): ?>
                            <span class="bento-status-badge"><?php echo htmlspecialchars($overdue_count); ?></span>
                        <?php endif; ?>
                    </a>
                <?php endif; ?>
                <a href="<?php echo $basePath . 'logout.php'; ?>" class="bento-nav-link bento-nav-link-danger">
